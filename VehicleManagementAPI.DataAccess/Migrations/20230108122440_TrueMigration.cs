        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DriverId = table.Column<string>(type: "nvarchar(36)", maxLength: 36, nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Assignment_Driver_DriverId",
                        column: x => x.DriverId,
                        principalTable: "Driver",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Assignment_Vehicle_VehicleId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Assignment_DriverId",
                table: "Assignment",
                column: "DriverId");

            migrationBuilder.CreateIndex(
                name: "IX_Assignment_VehicleId",
                table: "Assignment",
                column: "VehicleId");
